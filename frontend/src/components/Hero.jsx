    ...
    >
      ...
      <div className="relative z-10 px-6 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-10 w-full sm:w-auto">
          ...
          <a
            href="https://wa.me/573212334935?text=Hola,%20estoy%20interesado%20en%20conocer%20m%C3%A1s%20acerca%20de%20los%20servicios%20de%20transporte%20que%20ofrece%20VIP%20WHITE.%20Agradezco%20su%20informaci%C3%B3n."
            target="_blank"
